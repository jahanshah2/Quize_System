...
const QUIZE: {
  ...
  },
  {
    ...
    type: "list",
    message:
      "Which of the following is a correct way to define a variable in TypeScript?",
    choices: [
  ...
  },
  {
    ...
    type: "list",
    message:
      "How do you specify that a function returns a number in TypeScript?",
    choices: [
...
switch (QUIZE.quistion_1) {
  ...
  default:
    ...
    console.log(
      "1Q : This Is Correct Answer = c) Adding static types to JavaScript"
    );
    break;
}
...
switch (QUIZE.quistion_3) {
  ...
  default:
    ...
    console.log(
      "3Q : This Is Correct Answer = b) function add(a: number, b: number): number {}"
    );
    break;
}
...
switch (QUIZE.quistion_5) {
  ...
  default:
    ...
    console.log(
      "5Q : This Is Correct Answer = a) Asserts that a value is not null or undefined"
    );
    break;
}
